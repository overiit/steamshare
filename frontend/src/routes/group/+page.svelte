...
<section class="form">
  <div class="avatars">
    {#each members as member}
      <div class="avatar">
        <div class="action reload" on:click={() => {
  ...
  <div class="games">
    {#each games as game}
        <div class="game" style="background-image: linear-gradient(90deg, rgba(34, 36, 41, .75), rgba(34, 36, 41, .75)), url({game.background_image});">
            <div class="banner">
